...
import com.dsk.myexpense.expense_module.util.swipeLayout.StackTouchHelperCallback
import com.dsk.myexpense.expense_module.util.swipeLayout.touchelper.ItemTouchHelper.Callback
import java.util.*
...
(
    ...
    abstract class Callback {
        ...
        internal fun getAbsoluteMovementFlags(recyclerView: RecyclerView?, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        internal fun hasSwipeFlag(recyclerView: RecyclerView?, viewHolder: RecyclerView.ViewHolder): Boolean {
            val flags = getAbsoluteMovementFlags(recyclerView, viewHolder)
         ...
         * @see .onMoved
         */
        abstract fun onMove(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
         ...
         * moved to.
         */
        fun chooseDropTarget(selected: RecyclerView.ViewHolder, dropTargets: List<RecyclerView.ViewHolder>, curX: Int,
         ...
         * [RecyclerView.ItemDecoration]s.
         */
        fun onMoved(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, fromPos: Int,
         ...
         * @see .onChildDrawOver
         */
        open fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float,
         ...
         * @see .onChildDrawOver
         */
        fun onChildDrawOver(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
